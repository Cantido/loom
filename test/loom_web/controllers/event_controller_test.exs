defmodule LoomWeb.EventControllerTest do
  ...
  describe "create event" do
    ...
    test "renders event when data is valid", %{conn: conn, source: source} do
      conn =
        post(conn, Routes.event_path(conn, :create), Map.put(@create_attrs, :source, source))
  ...
  describe "show event" do
    test "renders an event", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "includes an etag header", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "includes an last-modified header", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "includes a cache-control header", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "returns 304 if the etag is the same", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "returns 304 if the modified time is before the if-modified-since header", %{conn: conn, team: team, source: source} do
      event = %{
        specversion: "1.0",
        id: "12345",
        source: source,
    ...
    test "returns 404 when event does not exist", %{conn: conn, source: source} do
      conn = get(conn, Routes.source_event_path(conn, :show, source, "12345"))
  ...
  describe "show stream" do
    test "returns all events in a stream", %{conn: conn, team: team, source: source} do
      event1 = %{
        id: "uuid-1",
        source: source,
        type: "com.example.event",
    ...
    test "returns events in a stream when limited", %{conn: conn, team: team, source: source} do
      event1 = %{
        id: "uuid-1",
        source: source,
        type: "com.example.event",
    ...
    test "returns the stream from a given point", %{conn: conn, team: team, source: source} do
      event1 = %{
        id: "uuid-1",
        source: source,
        type: "com.example.event",
    ...
    test "returns the stream backwards", %{conn: conn, team: team, source: source} do
      event1 = %{
        id: "uuid-1",
        source: source,
        type: "com.example.event",
